...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/chenchangshen/Desktop/FAQBIO490/qbio_490_ChangshenChen")) 
```
...
factor <- factor(c("at risk", "healthy")) 
factor
```
...
age <- 20
birthday <- "07/01/2004"
three_fav_colors <- c("red", "white", "black")
